...
inline void R3PlanarGrid::Voronoi(R2Grid *squared_distance_grid)  
  { grid.Voronoi(squared_distance_grid); }
...
inline void R3PlanarGrid::RasterizeGridSpan(const int p1[3], const int p2[3], RNScalar value)  
...
inline void R3PlanarGrid::RasterizeGridSpan(const R2Point& p1, const R2Point& p2, RNScalar value)  
  { grid.RasterizeGridSpan(p1, p2, value); }
inline void R3PlanarGrid::RasterizeGridTriangle(const int p1[3], const int p2[3], const int p3[3], RNScalar value)  
...
{ 
  ...
  return grid.RasterizeWorldSpan(R2Point(p1.X(), p1.Y()), R2Point(p2.X(), p2.Y()), value); 
}
...
{ 
  ...
  return grid.RasterizeWorldTriangle(R2Point(p1.X(), p1.Y()), R2Point(p2.X(), p2.Y()), R2Point(p3.X(), p3.Y()), value); 
}
