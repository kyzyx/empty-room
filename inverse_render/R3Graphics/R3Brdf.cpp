...
R3Brdf R3emissive_red_brdf;
R3Brdf R3emissive_green_brdf;
R3Brdf R3emissive_blue_brdf;
R3Brdf R3emissive_yellow_brdf;
R3Brdf R3emissive_cyan_brdf;
R3Brdf R3emissive_magenta_brdf;
R3Brdf R3emissive_white_brdf;
...
R3InitBrdf()
{
    R3emissive_red_brdf = R3Brdf(RNblack_rgb, RNblack_rgb, RNblack_rgb, RNred_rgb, 0., 1., 1.);
    R3emissive_green_brdf = R3Brdf(RNblack_rgb, RNblack_rgb, RNblack_rgb, RNgreen_rgb, 0., 1., 1.);
    R3emissive_blue_brdf = R3Brdf(RNblack_rgb, RNblack_rgb, RNblack_rgb, RNblue_rgb, 0., 1., 1.);
    R3emissive_yellow_brdf = R3Brdf(RNblack_rgb, RNblack_rgb, RNblack_rgb, RNyellow_rgb, 0., 1., 1.);
    R3emissive_cyan_brdf = R3Brdf(RNblack_rgb, RNblack_rgb, RNblack_rgb, RNcyan_rgb, 0., 1., 1.);
    R3emissive_magenta_brdf = R3Brdf(RNblack_rgb, RNblack_rgb, RNblack_rgb, RNmagenta_rgb, 0., 1., 1.);
    R3emissive_white_brdf = R3Brdf(RNblack_rgb, RNblack_rgb, RNblack_rgb, RNwhite_rgb, 0., 1., 1.);
    /* Return success */
    return TRUE;
}
...
SetOpacity(RNScalar opacity)
{
    ...
    if (opacity == 1.0) flags.Remove(R3_BRDF_TRANSPARENCY_FLAG);
    else flags.Add(R3_BRDF_TRANSPARENCY_FLAG);
