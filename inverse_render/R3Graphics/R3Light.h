...
class R3Light {
    ...
    virtual const R3Point& Position(void) const { return R3null_point; }
	virtual const RNBoolean IsActive(void) const;
  	virtual const RNScalar Intensity(void) const;
  	virtual const RNRgb& Color(void) const;
        virtual const R3Vector& Direction(void) const { return R3null_vector; }
        virtual const RNScalar ConstantAttenuation(void) const { return 0; }
        virtual const RNScalar LinearAttenuation(void) const { return 0; }
        virtual const RNScalar QuadraticAttenuation(void) const { return 1; }
