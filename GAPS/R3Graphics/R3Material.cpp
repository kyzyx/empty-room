...
R3Material R3emissive_red_material;
R3Material R3emissive_green_material;
R3Material R3emissive_blue_material;
R3Material R3emissive_yellow_material;
R3Material R3emissive_cyan_material;
R3Material R3emissive_magenta_material;
R3Material R3emissive_white_material;
...
R3InitMaterial()
{
    ...
    R3emissive_red_material = R3Material(&R3emissive_red_brdf, "EmissiveRed");
    R3emissive_green_material = R3Material(&R3emissive_green_brdf, "EmissiveGreen");
    R3emissive_blue_material = R3Material(&R3emissive_blue_brdf, "EmissiveBlue");
    R3emissive_yellow_material = R3Material(&R3emissive_yellow_brdf, "EmissiveYellow");
    R3emissive_cyan_material = R3Material(&R3emissive_cyan_brdf, "EmissiveCyan");
    R3emissive_magenta_material = R3Material(&R3emissive_magenta_brdf, "EmissiveMagenta");
    R3emissive_white_material = R3Material(&R3emissive_white_brdf, "EmissiveWhite");
